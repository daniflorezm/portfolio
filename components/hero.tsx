  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center px-6 pt-20 pb-16 overflow-hidden">
      ...
      <div className="relative max-w-5xl mx-auto flex flex-col md:flex-row items-center gap-12 md:gap-16">
        ...
        >
          <div className="relative w-48 h-48 md:w-64 md:h-64 rounded-2xl overflow-hidden border-2 border-border-accent">
            <Image
              src="/daniel-portfolio.jpeg"
          ...
          <div
            className="absolute -inset-2 rounded-2xl opacity-20 blur-xl -z-10"
